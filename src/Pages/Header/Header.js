  ...
  return (
    <div className="navbar">
      ...
      <div className="navbar-center md:pl-8 hidden lg:flex">
        ...
        <ul className="text-black text-base font-medium menu menu-horizontal xl:ml-20 p-0">
          <li className="m-2">
            <Link to="/">Home</Link>
          </li>
          <li className="m-2">
        ...
        <div className="relative  xl:ml-20">
          <input
            type="text"
            placeholder="Search"
            className="input xl:px-10  border-gray-200 input-bordered h-10 bg-white text-black"
          />
        ...
        <div className="relative">
          <button className="ml-4 xl:ml-12" type="button">
            <label htmlFor="my-drawer-4" className="drawer-button">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
